...
class Classifier:
    """A wrapper class for the HistGradientBoosting binary classifier.

    This class provides a consistent interface that can be used with other
    classifier models.
    """

    model_name = "HistGradientBoosting_binary_classifier"
    ...
    def fit(self, train_inputs: pd.DataFrame, train_targets: pd.Series) -> None:
        """Fit the HistGradientBoosting binary classifier to the training data.
    ...
    def evaluate(self, test_inputs: pd.DataFrame, test_targets: pd.Series) -> float:
        ...
        Returns:
            float: The accuracy of the HistGradientBoosting
 binary classifier.
        """
    ...
    def load(cls, model_dir_path: str) -> "Classifier":
        ...
        Returns:
            Classifier: A new instance of the loaded HistGradientBoosting
 binary classifier.
        """
